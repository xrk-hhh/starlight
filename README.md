...
**设计**
- 🎨 五套主题（v2.11 场景化，v2.13.1 双层星空）：深空星港 / 落日熔金 / 极光冰川 / 月白纸笺 / 樱庭薄暮——粒子·星云·流星随主题换色，每主题独立氛围层（落日日轮余晖 / 极光帘幕漂移 / 纸笺衬线字体 / 樱瓣飘落）。深色主题走 WebGL 加色星海（视差/主星交互），浅色主题走 2D Canvas 墨点星野（FlatStarfield，任何环境稳定可见），切主题即时无缝换层
