import { SITE_VERSION, SITE_VERSION_DATE } from './site'

// 版本星图数据（v2.15 从 VersionArchiveView 抽离为单一数据源）：
// 发版只在数组最顶部插入新条目（v: SITE_VERSION / date: SITE_VERSION_DATE / note），
// 顺序·去重·首条一致性由 versions.test.ts 保障——历史三次编辑错位事故不再可能溜进主干。
