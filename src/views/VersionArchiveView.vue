...
const versions = [
  {
    ...
    note: '五主题场景化重构：粒子·星云·流星随主题换色 + 每主题独立氛围层（落日日轮余晖 / 极光帘幕漂移 / 纸笺衬线字体 / 樱粉渐晕）/ 友邻扩容（+Jizen、+dmw、+杨禹然，共 9 位）/ 版本星图顺序修正（v2.3 归位于 v2.2 与 v2.4 之间）/ 快捷键中文输入法兼容（e.code 物理键位，中文 IME 下 ？/g/c/r 可用）/ giscus 评论区升级（滚动预载 + 主题跟随 + 慢网降级出口）/ 新增联络信使（姓名·邮箱·主题·消息，Web3Forms → mailto 双通道，零配置可用）',
  },
  {
    v: 'v2.10.0',
    date: '2026-08',
