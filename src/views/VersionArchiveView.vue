...
const versions = [
  {
    ...
    note: '星港电台大修：整曲 blob 预取根治「边下边播」卡顿 + WebAudio 真频谱（均衡器实电平驱动）+ 星海随音乐呼吸（粒子 uAudio uniform 随低频脉动）+ 播放/暂停音量渐变 / 联络信使 Web3Forms 直投上线（在线发送，不再唤起邮件客户端；密钥经 CI secret 注入，失败仍自动降级 mailto）/ 友邻轨道全员入轨（内圈 3 + 外圈 6，与下方列表一一对应）/ 导航正名 STARLIGHT / 电报发送成功流星彩蛋',
  },
  {
    v: 'v2.11.0',
    date: '2026-08',
